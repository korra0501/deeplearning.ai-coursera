...
- **LeNet-5**
  ...
  - ![](Images/05.png)
  - This model was published by Yann Lecun at 1998. The last layer wasn't using softmax back then.
...
- **AlexNet**
  ...
  - For example if the input is 227 x 227 x3 then these are the shapes of the of the outputs at each layer:
    ...
    - MAXPOOL1 (3 x 3 filters applied at stride 2)
      - Output shape `(27,27,96)`,   **No Parmeters**
    - NORM1
...
- **VGG-16**
  ...
  - Used the simple 3 x 3 Conv all through the network.
    - **3 (3 x 3) filters has the same effective receptive field as 7 x 7**
...
- **Inception module**, naive version:
  - ![](Images/13.png)
  - Hint that max-pool are same here: Adds padding to maintain the sizes.
